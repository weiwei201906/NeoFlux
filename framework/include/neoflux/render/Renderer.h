...
class Renderer {
 public:
  ...
  virtual void renderScene(const std::shared_ptr<core::Widget>& root, const core::BuildContext& context) = 0;
  ...
  // Return the last rendered frame preview as text.
  virtual std::string lastFramePreview() const = 0;
};
