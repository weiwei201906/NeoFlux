...
// Uses the explicit instantiations (ObjectPool<int>, ObjectPool<std::string>)
// provided by src/core/object_pool.cpp.
// =============================================================================
...
// TestObject aliases the explicitly instantiated ObjectPool<int>.
using TestObject = int;
