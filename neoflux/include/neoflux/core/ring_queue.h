...
// implementations live in src/core/ring_queue.cpp and are explicitly
// instantiated there for the types used by the framework (RenderCommand,
// int, uint64_t).
//
// To use this queue with a custom type, add an explicit instantiation for
// that type in one of your translation units and link against neoflux.
// =============================================================================
