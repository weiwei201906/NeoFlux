...
//
// Template method implementations live in src/core/object_pool.cpp and are
// explicitly instantiated there for the types used by the framework. To use
// the pool with your own type, add an explicit instantiation for that type
// in one of your translation units and link against neoflux.
// =============================================================================
